...
const startGame = async () => {
    ...
    function showConfirmModal(title, message, onConfirm) {
        ...
        overlay.innerHTML = `<div style="background:#fff;width:340px;border-radius:24px;padding:28px;text-align:center;transform:scale(0.9);transition:all 0.3s ease;box-shadow:0 20px 40px rgba(0,0,0,0.3);">
            ...
            <div style="display:flex;gap:16px;">
                ...
                <button id="modal-confirm" style="flex:1;padding:14px;border-radius:16px;background:#602EAB;color:#fff;font-weight:600;cursor:pointer;border:none;box-shadow:0 4px 12px rgba(96,46,171,0.3);">Подтвердить</button>
            </div>
        </div>`;
    ...
    function startWaitingTimer(waitingProgress, waitingSeconds) {
        ...
        let wait = 5;
        waitingSeconds.textContent = wait;

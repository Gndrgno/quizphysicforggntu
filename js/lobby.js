...
const startLobby = async () => {
    ...
    async function setupPlayerSession(code) {
        try {
            ...
            // === БЛОК СМЕНЫ ИМЕНИ: инпут и кнопка на одной строке, полная ширина ===
            if (!document.querySelector('.name-change-container')) {
                ...
                changeNameBtn.style.cssText = 'padding: 14px 18px; border-radius: 14px; background: #8a2be2; color: white; border: none; font-weight: 600; font-size: 15px; cursor: pointer; white-space: nowrap; box-shadow: 0 2px 6px rgba(138,43,226,0.3);';

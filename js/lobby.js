...
const startLobby = async () => {
    ...
    function updateAccessUI(code) {
        ...
        const url = `${window.location.origin}/lobby.html?code=${code}`;  // Уточнили путь
        nodes.quizLink.value = url;
        nodes.qrImage.src = `https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=${encodeURIComponent(url)}`;
    }
